SELECT user_id,
--EXTRACT(DOY FROM MAX(post_date))-EXTRACT(DOY FROM MIN(post_date)) as days_between -- Alternative if both dates are within same year.
...
| 661093  | 624356  | Bed. Class 8-12. Work 12-3. Gym 3-5 or 6. Then class 6-10. Another day... | 07/29/2021 13:00:00 |
